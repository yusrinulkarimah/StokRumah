const C='stok-rumah-realtime-requested-update';
...
self.addEventListener('install',event=>{
  event.waitUntil(caches.open('stok-rumah-realtime-requested-update').then(c=>c.addAll(['icon-192.png','icon-512.png'])).catch(()=>{}));
});
